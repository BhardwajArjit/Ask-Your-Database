...
def main():
    ...
    st.markdown("###### Welcome to our Generative AI Project! This project comprises two powerful components designed "
    ...
    st.markdown("1. **Ask Your Database**: An interactive chat application that allows you to query your MySQL or "
